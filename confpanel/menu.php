 ...
 <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="template.php" class="logo"><b>Rumah Souvenir | Admin Panel</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="profile.html"><img src="assets/img/rsp.jpeg" class="img-circle" width="60"></a></p>
                  <h5 class="centered"><?php  echo ucwords(@$_SESSION['fullname']);?></h5>
                  <div class="centered" id="jam" style="color:white;font-size:;">
