...
//fungsi fitur kirim email
        ...
        // More headers
        $headers .= 'From: <info@rumahsouvenirpurwakarta.com>' . "\r\n";
        $headers .= 'Cc: admin@rumahsouvenirpurwakarta.com' . "\r\n";
        @mail($to,$subject,$message,$headers);

        // Input data ke tbl_inbox                     
        $tambah = "INSERT INTO tbl_inbox (date_receive_inbox, name_inbox, email_inbox, subject_inbox, message_inbox)
            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="#" class="scroll-link" data-id="contact-us"><?=contactus?></a></li>
                    </ul>
                </div>
                <!--/.navbar-collapse-->
            </nav>
    ...
    <div class="parallax-content baner-content" id="home">
        <div class="container">
            <div class="text-content">
                ...
                foreach ($mysqli->get_show_profile() as $showprofile) {
                echo "
                <h2>$showprofile[titleparagraf]</h2>
                <p>$showprofile[welcomeparagraf]</p>";                    
                }
                ?>
    ...
    <div id="contact-us">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <h4><?=labelcontactus?></h4>
                        <div class="line-dec"></div>
                        <?php
                            foreach ($mysqli->get_show_contactus() as $showcontactus) {
                            echo " 
                            <p>$showcontactus[description_contactus]</p>";
                            }
                        ?>
                        <div class="pop-button">
                            <h4><?=buttonsendemail?></h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="pop">
                        ...
                        <form id="contact" action="index.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">                                
                                  <fieldset>
                                    <textarea name="message" rows="6" class="form-control" id="message" placeholder="<?=placemessage?>" required=""></textarea>
                                  </fieldset>
                                </div>
                                <div class="col-md-12">
                                  <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-12">
                    <div class="connect-us">
                        ...
                        echo "
                        <ul>                            
                            <li><a href='https://www.facebook.com/".$showcontactus['id_facebook']."' target=\"_blank\"><i class=\"fa fa-facebook\"></i></a></li>
                            <li><a href='https://www.instagram.com/".$showcontactus['id_instagram']."' target=\"_blank\"><i class=\"fa fa-instagram\"></i></a></li>
                            <li><a href='https://wa.me/".$showcontactus['id_twitter']."' target=\"_blank\"><i class=\"fa fa-whatsapp\"></i></a></li>
                            <li><a href='https://www.tiktok.com/".$showcontactus['id_youtube']."' target=\"_blank\"><i class=\"fa fa-youtube\"></i></a></li>
                        </ul>";
                            }
                        ?>
                        <?php 
